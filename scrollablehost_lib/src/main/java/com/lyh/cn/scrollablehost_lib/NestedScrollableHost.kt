package com.lyh.cn.scrollablehost_lib
...
/*    private val parentView: ViewPager2?
    ...
    private fun handleInterceptTouchEvent(e: MotionEvent) {
        ...
        if (parentView is RecyclerView){
            val layoutManager:LinearLayoutManager = ((parentView as RecyclerView).layoutManager ?: return) as LinearLayoutManager
            orientation = layoutManager.orientation
        }else{
            try {
                orientation = (parentView as ViewPager2).orientation
            }catch (e:Exception){
                return
            }
        }
